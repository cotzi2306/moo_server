...
const ventaLecheSchema = z.object({
...
export function validateVentaLeche(object) {
    return ventaLecheSchema.safeParse(object);
}

export function validatePartialVentaLeche(object) {
    return ventaLecheSchema.partial().safeParse(object);
}
